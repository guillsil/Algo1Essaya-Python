"""Escribir una función que reciba un número secreto (entero) y le pregunte un número al usuario.
Si el número ingresado es distinto, debe indicarle si es mayor o menor al número secreto y volver
