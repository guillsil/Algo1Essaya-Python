"""En cierto concurso, el ganador se elige de entre los participantes colocandolos en fila y siguiendo
bestos pasos:
...
Escribir una función elegir_participante que reciba una lista de participantes (que representa la fila) y devuelva
